...
// This header is needed until `is_feature_activated` and `preactivate_feature` are added to `act.cdt`
...
namespace eosio {
   ...
   /**
    * @defgroup eosiobios act.bios
    * @ingroup eosiocontracts
    *
    * act.bios is a minimalistic system contract that only supplies the actions that are absolutely
    * critical to bootstrap a chain and nothing more.
    *
    * @{
    */
   class [[eosio::contract("act.bios")]] bios : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiobios act.bios
} /// namespace eosio
