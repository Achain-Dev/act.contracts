...
namespace eosio {
   /**
    * @defgroup eosiowrap act.wrap
    * @ingroup eosiocontracts
    * act.wrap contract simplifies Block Producer superuser actions by making them more readable and easier to audit.
    ...
    * act.wrap allows for a cleaner method of implementing these important governance actions.
    * @{
    */
   class [[eosio::contract("act.wrap")]] wrap : public contract {
      public:
          ...
          *
          * @pre Requires authorization of act.wrap which needs to be a privileged account.
          *
   ...
   /** @}*/ // end of @defgroup eosiowrap act.wrap
} /// namespace eosio
