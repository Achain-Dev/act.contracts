...
#include <act.system/exchange_state.hpp>
#include <act.system/native.hpp>
...
namespace eosiosystem {
   ...
   /**
    *
    * @defgroup eosiosystem act.system
    ...
    */
   struct [[eosio::table, eosio::contract("act.system")]] name_bid {
     name            newname;
     name            high_bidder;
    ...
    */
   struct [[eosio::table, eosio::contract("act.system")]] bid_refund {
      name         bidder;
      asset        amount;
    ...
    */
   struct [[eosio::table("global"), eosio::contract("act.system")]] eosio_global_state : eosio::blockchain_parameters {
    ...
    */
   struct [[eosio::table, eosio::contract("act.system")]] producer_info {
      name                  owner;
    ...
    */
   struct [[eosio::table, eosio::contract("act.system")]] producer_info2 {
      name            owner;
   ...
   struct [[eosio::table, eosio::contract("act.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
    ...
    */
   struct [[eosio::table, eosio::contract("act.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("act.system")]] refund_request {
      name            owner;
    ...
    */
   struct [[eosio::table,eosio::contract("act.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
    ...
    */
   struct [[eosio::table,eosio::contract("act.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
    ...
    */
   struct [[eosio::table,eosio::contract("act.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
    ...
    */
   struct [[eosio::table,eosio::contract("act.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("act.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
    ...
    */
   class [[eosio::contract("act.system")]] system_contract : public native {
   ...
   /** @}*/ // end of @defgroup eosiosystem act.system
} /// eosiosystem
