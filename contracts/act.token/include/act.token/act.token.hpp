...
namespace eosio {
   ...
   /**
    * @defgroup eosiotoken act.token
    * @ingroup eosiocontracts
    *
    * act.token contract
    *
    * @details act.token contract defines the structures and actions that allow users to create, issue, and manage
    * tokens on achain based blockchains.
    * @{
    */
   class [[eosio::contract("act.token")]] token : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiotoken act.token
} /// namespace eosio
