...
namespace eosio {
   /**
    * @defgroup eosiomsig act.msig
    * @ingroup eosiocontracts
    * act.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   class [[eosio::contract("act.msig")]] multisig : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiomsig act.msig
} /// namespace eosio
